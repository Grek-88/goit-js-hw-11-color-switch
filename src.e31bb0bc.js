...
var randomIntegerFromInterval = function randomIntegerFromInterval() {
  var min = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var max = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : colors.length;
...
function changeBgBody() {
  document.body.style.backgroundColor = "".concat(colors[randomIntegerFromInterval()]);
